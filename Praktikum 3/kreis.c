...
/* Definition der Konstanten Pi durch PrÃ¤prozessoranweisung #define       */
/* jedes PI wird im Text durch 3.1415926 ersetzt                          */
#define PI 3.1415926

/* EinfÃ¼gen benÃ¶tigter Headerdateien in Quelltext   */
...
int main(int argc, char *argv[])
{
    ...
    do {
        ...
        printf("Anzahl der Aufrufe von kreisFlaeche(): %d\n", anzahl);
        printf(" Nochmal (j/n)?");
        erg = scanf(" %c", &jn);
    } while(jn == 'j');
